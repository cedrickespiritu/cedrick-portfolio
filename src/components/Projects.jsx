    ...
    <div className="h-full lg:h-screen bg-cover bg-center bg-no-repeat bg-primary font-manrope py-[4.5rem]">
      <div className="flex flex-col justify-center items-center min-h-[85vh] max-w-[1000px] mx-auto px-5 md:px-8 text-white gap-10">
        ...
        <ul className="flex flex-wrap gap-[1rem] md:gap-[3rem] align-center justify-center">
          <li className="portfolio-card-li" onClick={handleOpenModal}  style={{ backgroundImage: "url('/assets/img/project-img/web-development/ub-360.png')" }}>
          ...
          <li className="portfolio-card-li" onClick={handleOpenModal} style={{ backgroundImage: "url('/assets/img/project-img/motion-graphics/cbi-intro.png" }}>
            <span className="portfolio-card-span">
          ...
          <li className="portfolio-card-li" onClick={handleOpenModal} style={{ backgroundImage: "url('/assets/img/project-img/print-materials/standee.png')" }}>
            <span className="portfolio-card-span">
          ...
          <li className="portfolio-card-li" onClick={handleOpenModal} style={{ backgroundImage: "url('/assets/img/project-img/animation/nagkabangaan.png')" }}>
            <span className="portfolio-card-span">
              <span className="animation-card">
          ...
          <li className="portfolio-card-li" onClick={handleOpenModal} style={{ backgroundImage: "url('/assets/img/project-img/vexel/buena.png')" }}>
            <span className="portfolio-card-span">
          ...
          <li className="portfolio-card-li" onClick={handleOpenModal} style={{ backgroundImage: "url('/assets/img/project-img/shirt-design/shirt1.png')" }}>
            <span className="portfolio-card-span">
          ...
          <li className="portfolio-card-li" onClick={handleOpenModal} style={{ backgroundImage: "url('/assets/img/project-img/logo/logo1.png')" }}>
            <span className="portfolio-card-span">
          ...
          <li className="portfolio-card-li" onClick={handleOpenModal} style={{ backgroundImage: "url('/assets/img/project-img/poster/poster1.png')" }}>
            <span className="portfolio-card-span">
