...
const Hero = () => {
  ...
  return (
    <div className="h-screen bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(./src/assets/img/hero-bg.png)`, backgroundColor: '#20202b',backgroundBlendMode: 'overlay', }}>
